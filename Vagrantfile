...
Vagrant.configure("2") do |config|
  ...
  workerNodeIps = "shared/provision_helpers/node_external_ips"
  clusterNodeIps = "shared/provision_helpers/node_internal_ips"
  ...
  open('shared/provision_helpers/node_external_ips', 'w') { |f|
  ...
  open('shared/provision_helpers/node_external_ips', 'a') { |f|
